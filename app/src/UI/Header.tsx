            ...
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -inset-2 rounded-full bg-linear-to-r from-[#a78bfa] via-[#ec4899] to-[#a78bfa] opacity-20 blur-md"
                />
                ...
                <div className="relative w-10 h-10 sm:w-14 sm:h-14 rounded-2xl
                  ...
                  <motion.div
                    className="absolute inset-0 bg-linear-to-r from-[#a78bfa]/20 to-[#ec4899]/20"
                    animate={{ x: ["0%", "100%", "0%"] }}
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <motion.button
            ...
            className="px-7 py-3 rounded-xl font-bold text-sm
                     bg-linear-to-r from-[#a78bfa] via-[#a78bfa] to-[#ec4899]
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-linear-to-r from-[#a78bfa] via-[#ec4899] to-[#a78bfa]"
              animate={{
                background: ["linear-gradient(45deg, #a78bfa, #ec4899, #a78bfa)",
                           "linear-gradient(45deg, #ec4899, #a78bfa, #ec4899)"]
              }}
          ...
          <>
            ...
            <motion.div
              ...
              className="fixed top-24 right-4 left-4 z-50 rounded-2xl
                        bg-white/95 dark:bg-[#111111]/95 backdrop-blur-2xl
                        border border-slate-200 dark:border-[#faf8f0]/10
                        shadow-2xl shadow-black/30
                        overflow-hidden lg:hidden"
            >
              {/* Menu Header */}
              <div className="p-6 border-b border-slate-100 dark:border-[#faf8f0]/5">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-linear-to-r from-[#a78bfa] to-[#ec4899]" />
                    <span className="text-lg font-bold text-slate-900 dark:text-[#faf8f0]">
                      Navigation
                    </span>
                  </div>
              ...
              <div className="p-4">
                {navItems.map((item, index) => (
                  ...
                  >
                    {/* Animated background */}
                    <motion.div
                      className="absolute inset-0 bg-linear-to-r from-[#a78bfa]/0 via-[#a78bfa]/5 to-[#ec4899]/0"
                      initial={{ x: "-100%" }}
                      whileHover={{ x: "100%" }}
                      transition={{ duration: 0.6 }}
                    />
              ...
              {/* Menu Footer */}
              <div className="p-6 border-t border-[#faf8f0]/5 bg-linear-to-b from-transparent to-[#111111]/30">
                {/* Social Links */}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <motion.button
                    ...
                    className="col-span-1 px-4 py-3 rounded-xl font-bold text-sm
                              bg-linear-to-r from-[#a78bfa] to-[#ec4899]
