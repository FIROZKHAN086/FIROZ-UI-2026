...
const expertiseData = {
  frontend: {
    ...
    description:
      "Crafting immersive, performant user experiences with modern frameworks",
...
export const AboutC = () => {
  const [activeCategory, setActiveCategory] =
    useState<ExpertiseKey>("frontend");
  ...
  const principles = [
    ...
    },
    {
      ...
      description:
        "Creating intuitive, accessible, and engaging interfaces that users love",
      gradient: "from-[#a78bfa] to-[#ec4899]",
    ...
    },
    {
      ...
      description:
        "Implementing robust security measures to protect applications and data",
      gradient: "from-[#10b981] to-[#06b6d4]",
    ...
    },
    {
      ...
      title: "Performance",
      description:
        "Optimizing for speed, efficiency, and optimal resource utilization",
  ...
  const processSteps = [
    ...
    },
    {
      ...
      title: "Strategy",
      description:
        "Planning architecture, technology stack, and development approach",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="section-title text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="text-[#faf8f0]">Crafting Digital</span>
          ...
          >
            Transforming complex challenges into elegant, high-performance
            digital solutions through innovative technology, meticulous design,
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="p-6 rounded-2xl backdrop-blur-xl border bg-[#111111]/50 border-[#faf8f0]/10">
                ...
                <div className="text-3xl font-bold mb-1 text-[#faf8f0]">
                  {stat.value}
                </div>

                <div className="text-sm font-semibold mb-1 text-[#faf8f0]/80">
                  {stat.label}
                </div>

                <div className="text-xs text-[#faf8f0]/60">
                  {stat.description}
                </div>
              </div>

              <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-transparent via-transparent to-[#faf8f0]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
            </motion.div>
          ))}
        </div>
          ...
          <div>
                ...
                {[
                  {
                    ...
                    description:
                      "Began with HTML/CSS fundamentals, evolved through JavaScript mastery to modern frameworks like React and Next.js",
                  },
                  {
                    icon: "💡",
                    title: "Problem-Solving Focus",
                    description:
                      "Specialized in transforming complex business requirements into elegant technical solutions with scalable architecture",
                  },
                  {
                    icon: "📈",
                    title: "Continuous Evolution",
                    description:
                      "Constantly learning and adapting to new technologies while maintaining excellence in core web development principles",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
            ...
            <div className="grid grid-cols-2 gap-4">
              {principles.map((principle, index) => (
                ...
                >
                  <div
                    className={`inline-flex p-2 rounded-lg bg-linear-to-br ${principle.gradient} mb-3`}
                  >
          ...
          <div>
              ...
              >
                <div className="rounded-3xl p-8 glass">
                  ...
                  <div className="space-y-4">
                    {expertiseData[activeCategory].technologies.map(
                      (tech, index) => (
                        <motion.div
                          key={index}
            ...
            <div className="grid grid-cols-3 gap-3">
              {Object.entries(expertiseData).map(([key, category]) => (
                ...
                >
                  <div
                    className={`p-3 rounded-lg mb-3 inline-flex ${
                      activeCategory === key
                        ? "bg-[#0a0a0a]/20"
