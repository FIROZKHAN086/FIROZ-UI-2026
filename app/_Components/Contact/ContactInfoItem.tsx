...
export const ContactInfoItem = ({
  ...
  return (
    <div ref={itemRef} className="relative">
      <motion.div
        whileHover={{ x: 10 }}
        className="flex items-start space-x-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-white/10 hover:to-transparent transition-all duration-300 group"
      >
        <motion.div
          className="relative"
        ...
        >
          ...
          <div className="relative text-2xl bg-gradient-to-br from-purple-500 to-pink-500 bg-clip-text text-transparent">
            {icon}
          </div>
        </motion.div>

        <div className="flex-1">
          <h4 className="font-bold text-lg mb-2 bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-200 dark:to-gray-400 bg-clip-text text-transparent">
            {title}
          </h4>
