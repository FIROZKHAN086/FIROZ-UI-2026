...
export function ProjectCard({ project, onEdit, onDelete, onDuplicate }: ProjectCardProps) {
  return (
    <Card className={cn(
      "group overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border",
      project.featured 
        ? "border-blue-300 dark:border-blue-700 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/10 dark:to-gray-800" 
